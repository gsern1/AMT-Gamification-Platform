...
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.SpringCodegen", date = "2016-12-10T11:02:59.642+01:00")
...
@ApiParam(value = "application object to add to the platform" ,required=true ) @RequestBody Application application
...
@ApiParam(value = "application object to add to the store" ,required=true ) @RequestBody Application application
